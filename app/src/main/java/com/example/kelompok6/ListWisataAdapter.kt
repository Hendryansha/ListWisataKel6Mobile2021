...
class ListWisataAdapter(val listWisata: ArrayList<Wisata>) : RecyclerView.Adapter<ListWisataAdapter.ListViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ListViewHolder, position: Int) {
        val (name, photo, overview, identity) = listWisata[position]
        ...
        holder.itemView.setOnClickListener {
            ...
            moveDetail.putExtra(detail_wisata.EXTRA_NAME, name)
            moveDetail.putExtra(detail_wisata.EXTRA_PHOTO, photo)
            moveDetail.putExtra(detail_wisata.EXTRA_DETAIL, identity)
            moveDetail.putExtra(detail_wisata.EXTRA_OVERVIEW, overview)
